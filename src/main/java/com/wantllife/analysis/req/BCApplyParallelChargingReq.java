...
public class BCApplyParallelChargingReq extends FrameHeader {
    ...
    private void log(String rawHexMsg) {
        ...
        String devLabel = GREEN + "⇑ 【0xA1】 " + deviceId + RESET;
        sb.append("\n\n");
        ...
        sb.append(String.format("🟢%s 主动申请并充  启动方式    startupModeDesc              : %s\n", devLabel, startupModeDesc));
        ...
        sb.append(String.format("🟢%s 主动申请并充  主辅标记    priAndSecFlagDesc            : %s\n", devLabel, priAndSecFlagDesc));
