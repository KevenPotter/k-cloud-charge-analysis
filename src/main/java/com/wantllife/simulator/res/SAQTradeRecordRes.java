...
public class SAQTradeRecordRes extends FrameHeader {
    ...
    private void log(String rawHexMsg) {
        ...
        log.info("🚀 【0x3B】 {} 交易记录上报  设备编号    deviceId                     : {}", PURPLE + deviceId + RESET, deviceId);
        log.info("🚀 【0x3B】 {} 交易记录上报  枪口编号    gunNo                        : {}", PURPLE + deviceId + RESET, gunNo);
        log.info("🚀 【0x3B】 {} 交易记录上报  交易编号    tradeNo                      : {}", PURPLE + deviceId + RESET, tradeNo);
        log.info("🚀 【0x3B】 {} 交易记录上报  时间范围    timeRange                    : {}-{}", PURPLE + deviceId + RESET, startTime, endTime);
        log.info("🚀 【0x3B】 {} 交易记录上报  尖时单价    sharpUnitPrice               : {}", PURPLE + deviceId + RESET, sharpUnitPrice);
        log.info("🚀 【0x3B】 {} 交易记录上报  尖时电量    sharpElectricity             : {}", PURPLE + deviceId + RESET, sharpElectricity);
        log.info("🚀 【0x3B】 {} 交易记录上报  尖时计损    sharpLossElectricity         : {}", PURPLE + deviceId + RESET, sharpLossElectricity);
        log.info("🚀 【0x3B】 {} 交易记录上报  尖时金额    sharpAmount                  : {}", PURPLE + deviceId + RESET, sharpAmount);
        log.info("🚀 【0x3B】 {} 交易记录上报  峰时单价    peakUnitPrice                : {}", PURPLE + deviceId + RESET, peakUnitPrice);
        log.info("🚀 【0x3B】 {} 交易记录上报  峰时电量    peakElectricity              : {}", PURPLE + deviceId + RESET, peakElectricity);
        log.info("🚀 【0x3B】 {} 交易记录上报  峰时计损    peakLossElectricity          : {}", PURPLE + deviceId + RESET, peakLossElectricity);
        log.info("🚀 【0x3B】 {} 交易记录上报  峰时金额    peakAmount                   : {}", PURPLE + deviceId + RESET, peakAmount);
        log.info("🚀 【0x3B】 {} 交易记录上报  平时单价    flatUnitPrice                : {}", PURPLE + deviceId + RESET, flatUnitPrice);
        log.info("🚀 【0x3B】 {} 交易记录上报  平时电量    flatElectricity              : {}", PURPLE + deviceId + RESET, flatElectricity);
        log.info("🚀 【0x3B】 {} 交易记录上报  平时计损    flatLossElectricity          : {}", PURPLE + deviceId + RESET, flatLossElectricity);
        log.info("🚀 【0x3B】 {} 交易记录上报  平时金额    flatAmount                   : {}", PURPLE + deviceId + RESET, flatAmount);
        log.info("🚀 【0x3B】 {} 交易记录上报  谷时单价    valleyUnitPrice              : {}", PURPLE + deviceId + RESET, valleyUnitPrice);
        log.info("🚀 【0x3B】 {} 交易记录上报  谷时电量    valleyElectricity            : {}", PURPLE + deviceId + RESET, valleyElectricity);
        log.info("🚀 【0x3B】 {} 交易记录上报  谷时计损    valleyLossElectricity        : {}", PURPLE + deviceId + RESET, valleyLossElectricity);
        log.info("🚀 【0x3B】 {} 交易记录上报  谷时金额    valleyAmount                 : {}", PURPLE + deviceId + RESET, valleyAmount);
        log.info("🚀 【0x3B】 {} 交易记录上报  电表起值    electricityStart             : {}", PURPLE + deviceId + RESET, electricityStart);
        log.info("🚀 【0x3B】 {} 交易记录上报  电表止值    electricityEnd               : {}", PURPLE + deviceId + RESET, electricityEnd);
        log.info("🚀 【0x3B】 {} 交易记录上报  总用电量    totalElectricity             : {}", PURPLE + deviceId + RESET, totalElectricity);
        log.info("🚀 【0x3B】 {} 交易记录上报  计损电量    totalLossElectricity         : {}", PURPLE + deviceId + RESET, totalLossElectricity);
        log.info("🚀 【0x3B】 {} 交易记录上报  消费金额    totalAmount                  : {}", PURPLE + deviceId + RESET, totalAmount);
        log.info("🚀 【0x3B】 {} 交易记录上报  车识别码    VIN                          : {}", PURPLE + deviceId + RESET, vinCode);
        log.info("🚀 【0x3B】 {} 交易记录上报  交易标识    tradeIdentifierDesc          : {}", PURPLE + deviceId + RESET, tradeIdentifierDesc);
        log.info("🚀 【0x3B】 {} 交易记录上报  交易日期    tradeTime                    : {}", PURPLE + deviceId + RESET, tradeTime);
        log.info("🚀 【0x3B】 {} 交易记录上报  停止原因    stopReasonDesc               : {}", PURPLE + deviceId + RESET, stopReasonDesc);
        log.info("🚀 【0x3B】 {} 交易记录上报  物理卡号    physicalCardNo               : {}", PURPLE + deviceId + RESET, physicalCardNo);
        System.out.println();
    }
}
