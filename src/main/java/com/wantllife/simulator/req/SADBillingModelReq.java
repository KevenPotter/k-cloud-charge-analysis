...
public class SADBillingModelReq extends FrameHeader {
    ...
    /* 有参构造 */
    public SADBillingModelReq(byte[] data, String rawHexMsg) {
        // 1.自助解析帧头
    ...
    private void parseBody(byte[] data) {
        ...
        index += 4;
        // 计损比例 [1字节] [BIN]
        this.setLossRatio((int) data[index] & 0xFF);
        index += 1;
        // 时段费率 [48字节] [BIN]
    ...
    private void parseDynamicTimeSlots() {
        ...
        // 4.赋值给最终列表,不再强制补单条类型(原始报文全覆盖无需补空段)
    ...
    private void log(String rawHexMsg) {
        ...
        String devLabel = PURPLE + "⇑ 【0x0A】 " + deviceId + RESET;
        sb.append("\n\n");
