...
public class SAXBillingModeSetReq extends FrameHeader {
    ...
    private void log(String rawHexMsg) {
        log.info("-------------------------------------------------------------------------------------------");
        log.info("👨‍🚀 【0x58】 {} 计费模型设置  原始报文    rawMsg                       : {}", PURPLE + deviceId + RESET, rawHexMsg);
        log.info("👨‍🚀 【0x58】 {} 计费模型设置  设备编号    deviceId                     : {}", PURPLE + deviceId + RESET, deviceId);
        log.info("👨‍🚀 【0x58】 {} 计费模型设置  计费编码    billingModeId                : {}", PURPLE + deviceId + RESET, billingModeId);
        log.info("👨‍🚀 【0x58】 {} 计费模型设置  尖电费率    sharpEleFee                  : {}", PURPLE + deviceId + RESET, sharpEleFee);
        log.info("👨‍🚀 【0x58】 {} 计费模型设置  尖服费率    sharpServiceFee              : {}", PURPLE + deviceId + RESET, sharpServiceFee);
        log.info("👨‍🚀 【0x58】 {} 计费模型设置  峰电费率    peakEleFee                   : {}", PURPLE + deviceId + RESET, peakEleFee);
        log.info("👨‍🚀 【0x58】 {} 计费模型设置  峰服费率    peakServiceFee               : {}", PURPLE + deviceId + RESET, peakServiceFee);
        log.info("👨‍🚀 【0x58】 {} 计费模型设置  平电费率    flatEleFee                   : {}", PURPLE + deviceId + RESET, flatEleFee);
        log.info("👨‍🚀 【0x58】 {} 计费模型设置  平服费率    flatServiceFee               : {}", PURPLE + deviceId + RESET, flatServiceFee);
        log.info("👨‍🚀 【0x58】 {} 计费模型设置  谷电费率    valleyEleFee                 : {}", PURPLE + deviceId + RESET, valleyEleFee);
        log.info("👨‍🚀 【0x58】 {} 计费模型设置  谷服费率    valleyServiceFee             : {}", PURPLE + deviceId + RESET, valleyServiceFee);
        log.info("👨‍🚀 【0x58】 {} 计费模型设置  计损比例    lossRatio                    : {}", PURPLE + deviceId + RESET, lossRatio);
        for (StandardBillingModel mode : billingModelList) {
            switch (mode.getTimeSlotType()) {
                case 1:
                    log.info("👨‍🚀 【0x58】 {} 计费模型设置  尖时间段    sharpTime                    : {}-{}", PURPLE + deviceId + RESET, mode.getStartTime(), mode.getEndTime());
                    break;
                case 2:
                    log.info("👨‍🚀 【0x58】 {} 计费模型设置  峰时间段    peakTime                     : {}-{}", PURPLE + deviceId + RESET, mode.getStartTime(), mode.getEndTime());
                    break;
                case 3:
                    log.info("👨‍🚀 【0x58】 {} 计费模型设置  平时间段    flatTime                     : {}-{}", PURPLE + deviceId + RESET, mode.getStartTime(), mode.getEndTime());
                    break;
                case 4:
                    log.info("👨‍🚀 【0x58】 {} 计费模型设置  谷时间段    valleyTime                   : {}-{}", PURPLE + deviceId + RESET, mode.getStartTime(), mode.getEndTime());
                    break;
            }
        }
        System.out.println();
